...
public final class InternalThreadLocalMap extends UnpaddedInternalThreadLocalMap {
    ...
    //相当于get方法了，但是会判断下当前的Thread类型，如果是FastThreadLocalThread，就返回其中的InternalThreadLocalMap
    //如果是系统的Thread，那么就返回UnpaddedInternalThreadLocalMap中的ThreadLocal中的InternalThreadLocalMap
    ...
    //和上面的方法其实是大同小异了，主要就是FastThreadLocalThread中的Map，是懒加载。
    ...
    private InternalThreadLocalMap() {
        //初始化
        //同时给UnpaddedInternalThreadLocalMap中的数组分配一个32长度的Object数组
