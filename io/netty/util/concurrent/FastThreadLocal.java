 ...
 * @see ThreadLocal
 */
//这个类，很厉害，从名字就可以看出来，它声称比系统自带的ThreadLocal更快
//并且他不是为系统的Thread准备的，而是为netty自己写的FastThreadLocalThread写的
//它的实现方法就是摒弃了ThreadLocalMap的线性探测法，而是每个ThreadLocal分配一个固定的id，底层还是选择的数组
public class FastThreadLocal<V> {

    //这个值是固定的，因为static域的只初始化一次。。
    //还没看懂这个有什么意思。
